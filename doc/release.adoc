...
including MSI installers and system-ready tarballs across Linux, macOS, and Windows platforms.
...
See installation options above for Windows MSI, Linux tarball, macOS, and cargo methods.
